...
(function ($) {
    ...
    $.fn.lightGallery = function (options) {
        var defaults = {
				...
				onSlideDownload : function(plugin) {},
				onSlideFav : function(plugin) {},
				onSlideDel : function(plugin) {},				
        ...
        var setUp = {
            ...
            slideTo: function () {
                ...
                if (settings.controls === true && $children.length > 1) {
					...
					$download.bind('click', function() {
						$this.onSlideDownload(index);
						clearInterval(interval);
					});
					//$favrt.bind('click', function() {
			...
			onSlideDownload : function(index) {	
				var url = $children.eq(index).attr('data-src');
				imgDownload(url);			
			},
			onSlideFav : function(index) {				
				swal({   title: "Sorry :(",   text: "This option will be available in next version.",   timer: 2000,   showConfirmButton: false });
			},
			onSlideDel : function(index) {
				var str = $children.eq(index).attr('data-src');
